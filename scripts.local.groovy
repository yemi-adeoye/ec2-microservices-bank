...
def copyJarToEC2() {
    ...
    sh '''sshpass -p ${LOCAL_EC2_PASSWORD} scp -P 8023 StrictHostKeyChecking=no ./target/banks-ms-0.0.1-SNAPSHOT.jar ${USER}@${BANK_MS_LOCALHOST}:~/${BANK_MS_DIR}/${BANK_MS_FILE}'''
}
